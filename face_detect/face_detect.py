...
vol_up_cascade=cv2.CascadeClassifier('thumbs_up_dasar_Ateam.xml')
vol_down_cascade=cv2.CascadeClassifier('thumbs_down_dasaar_Ateam-colored.xml')
...
while True:                  #While loop to capture the frame continuosly
    ...
    play=play_cascade.detectMultiScale(gray,1.4,5)      #detecting closed fist and saving into varaible 'play'
    ...
    vol_down=vol_down_cascade.detectMultiScale(gray,1.3,5)
